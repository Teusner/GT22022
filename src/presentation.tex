...
\begin{document}
    ...
    \section{Orthogonal constraint}
        ...
        \begin{frame}{1 Constraint - $w$ injection}
            \begin{minipage}{.6\textwidth}
                \begin{figure}
                    \centering
                    ...
                    \caption{1 orthogonal constraint with $w$ injection}
                \end{figure}
            \end{minipage}
            \hfill
            \begin{minipage}{.38\textwidth}
        ...
        \begin{frame}{Plane following - $w$ injection}
            \begin{minipage}{.6\textwidth}
                \begin{figure}
                    \centering
                    ...
                    \caption{Plane following with $w$ injection}
                \end{figure}
            \end{minipage}
            \hfill
            \begin{minipage}{.38\textwidth}
                \begin{block}{Simulation}
                    ...
                    \begin{itemize}
                        \item 1 constraint $\mathbf{\color{ForestGreen}{v}} \bot \mathbf{\color{red}{u}}$
                        \item $\mathbf{\color{red}{u}} = AxisRot(\frac{\pi}{8}, \mathbf{y})$
                        \item $\mathbf{\color{ForestGreen}{v}} = (1,0,0)^T$
                    \end{itemize}
                \end{block}
                \begin{block}{Simulation}
