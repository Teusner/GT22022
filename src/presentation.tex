            ...
            \begin{minipage}{0.4\textwidth}
                \begin{figure}
                    \begin{tikzpicture}
                        ...
                        \draw[rotate=155,thick,ForestGreen,->,>=latex] (c1) -- +(0:1cm) node[midway,above] {$\mathbf{v}$};
                        ...
                        \draw[rotate=205,thick,ForestGreen,->,>=latex] (c2) -- +(0:1cm) node[midway,above] {$\mathbf{v}$};
                    \end{tikzpicture}
                    \caption{Wall avoidance}
                \end{figure}
            \end{minipage}
            \hfill
            \begin{minipage}{0.55\textwidth}
