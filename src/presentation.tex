        ...
        \begin{frame}{Determine $\mathbf{R_w}$ - Classical way}
            ...
            \begin{minipage}{0.55\textwidth}
                ...
                \begin{block}<2->{Issue}
                    ...
                    \onslide<3>{$\color{red}{||\mathbf{w}|| = 0}$}
                \end{block}
            \end{minipage}
        \end{frame}
                    ...
                    \begin{tikzpicture}
                        ...
                        \onslide<4-> {
                            \begin{scope}[xshift=-2cm,yshift=.5cm]
                                ...
                                \draw[rotate=-25,thick,ForestGreen,->,>=latex] (c2) -- +(0:1cm) node[midway,above] {$\mathbf{v_2}$};
                            \end{scope}
                        }
                    \end{tikzpicture}
            ...
            \begin{minipage}{0.55\textwidth}
                \begin{figure}
                    \begin{tikzpicture}[decoration=triangles,rotate=-65]
                        ...
                        \onslide<3-> {
                            \draw[thick,ForestGreen,->,>=latex] (0,0) -- (210:1.5) node[midway,above] {$\mathbf{v_1}$};
                        }

                        \onslide<4-> {
                            \draw[thick,ForestGreen,->,>=latex] (0,0) -- (40:1.5) node[midway,below] {$\mathbf{v_2}$};
                        }
