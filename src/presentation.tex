            ...
            \begin{minipage}{0.8\textwidth}
                ...
                \begin{figure}
                    \begin{tikzpicture}[
                        ...
                        block/.style={draw,fill=white,font=\small,thick,
                        ...
                        \draw[thick,->,>=latex,RoyalBlue] (n1) to node[midway,above] {$w$} (n2);
                        ...
                        \draw[input,red] (u) -- node[midway,left,red] {$u$} (n1.100);
                        \draw[input,ForestGreen] (v) -- node[midway,right,ForestGreen] {$v$} (n1.80);
                    \end{tikzpicture}
